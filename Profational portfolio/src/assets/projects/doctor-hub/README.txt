...
2. Open src/data/projects.js and find the project with id: "doctor-hub"

3. At the top of projects.js, import each image:
     import doctor_hub_1 from "../assets/projects/doctor-hub/screen-1.png";
     import doctor_hub_2 from "../assets/projects/doctor-hub/screen-2.png";

4. On that project's object, set:
     image: doctor_hub_1,                         // shown on the project
                                                     // card in the Projects grid
     gallery: [doctor_hub_1, doctor_hub_2],        // ALL images shown on the
                                                     // project detail page
