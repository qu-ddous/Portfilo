    ...
    >
      ...
      <div className="absolute inset-0">
        <img
          ...
          className={`w-full h-full object-cover object-[65%_center] sm:object-[75%_center] scale-[1.02] ${
            isLight
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-10 pt-28 pb-20 w-full">
        ...
        <motion.h1
          ...
          className="font-display font-semibold text-3xl sm:text-5xl md:text-6xl lg:text-7xl text-ivory leading-[1.1] sm:leading-[1.05] max-w-3xl text-balance"
        >
