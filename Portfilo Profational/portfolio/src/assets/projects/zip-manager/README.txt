This folder is for: zip-manager
...
2. Open src/data/projects.js and find the project with id: "zip-manager"

3. At the top of projects.js, import each image:
     import zip_manager_1 from "../assets/projects/zip-manager/screen-1.png";
     import zip_manager_2 from "../assets/projects/zip-manager/screen-2.png";

4. On that project's object, set:
     image: zip_manager_1,                         // shown on the project
                                                     // card in the Projects grid
     gallery: [zip_manager_1, zip_manager_2],        // ALL images shown on the
                                                     // project detail page
